...
const ViewPosts = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios.get('https://cors-everywhere-me.herokuapp.com/http://ec2-35-173-188-150.compute-1.amazonaws.com:3001/api/private/posts')
  ...
  const sendUpdateRequest = async (ratedPost, updatedPost) => {
    try {
      ...
      await axios.put('https://cors-everywhere-me.herokuapp.com/http://ec2-35-173-188-150.compute-1.amazonaws.com:3001/api/private/posts/' + ratedPost._id, updatedPost, {headers: {'authorization': token}})
  ...
  const handleRemove = async (post) => {
    ...
    try{
      const token = localStorage.getItem('authToken')
      await axios.delete('https://cors-everywhere-me.herokuapp.com/http://ec2-35-173-188-150.compute-1.amazonaws.com:3001/api/private/posts/' + postId, {headers: {'authorization': token}})
